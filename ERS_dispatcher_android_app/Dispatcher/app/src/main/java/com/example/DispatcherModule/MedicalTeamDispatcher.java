...
public class MedicalTeamDispatcher extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_team_dispatcher);
...
//        btnshow = (Button) findViewById(R.id.showDetails);
    ...
    public void noShow(){
        Toast.makeText(MedicalTeamDispatcher.this,"Currently no Accident Reported!",Toast.LENGTH_SHORT).show();
    }
    public void showLogout(){

        final androidx.appcompat.app.AlertDialog.Builder dialog = new androidx.appcompat.app.AlertDialog.Builder(MedicalTeamDispatcher.this,R.style.AlertDialog);
//                final androidx.appcompat.app.AlertDialog alertDialog = dialog.create();
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actualDistance = 0;
                FirebaseAuth.getInstance().signOut();
                Intent intent = new Intent(MedicalTeamDispatcher.this, MainActivity.class);
                startActivity(intent);
                alertDialog.dismiss();
                finish();
    ...
    private void alertDispatcher() {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,CHANNEL_ID)
                ...
                .setContentText("Accident has been reported ")
    ...
    private void getAssignedCustomerPickupLocation(){
        assignedCustomerPickupLocationRef = FirebaseDatabase.getInstance().getReference().child("MedicalRequest").child(customerId).child("l");
        ...
        assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    Toast.makeText(MedicalTeamDispatcher.this, "Distance " + distance, Toast.LENGTH_SHORT).show();
...
//            mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
            ...
            DatabaseReference refAvailable = FirebaseDatabase.getInstance().getReference("MedicalTeamAvailable");
            DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("MedicalTeamWorking");
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(MedicalTeamDispatcher.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
        ...
        switch (requestCode) {
            case LOCATION_REQUEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MedicalTeamDispatcher.this, "Please provide the permission", Toast.LENGTH_SHORT).show();
                }
                break;
            }
    ...
    private void disconnectDriver(){
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("MedicalTeamAvailable");
        actualDistance = 0;
        GeoFire geoFire = new GeoFire(ref);
        geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
            @Override
            public void onComplete(String key, DatabaseError error) {
                Toast.makeText(MedicalTeamDispatcher.this, "You are now Offline", Toast.LENGTH_SHORT).show();
...
//                dialog.setView(trip_layout);
    ...
    private void endRide(){
        ...
        DatabaseReference driverRef  = FirebaseDatabase.getInstance().getReference().child("Users").child("Dispatcher").child("MedicalTeam").child(userId).child("userRideId");
        ...
        geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
            @Override
            public void onComplete(String key, DatabaseError error) {
                Toast.makeText(MedicalTeamDispatcher.this,"Service Done",Toast.LENGTH_LONG).show();
    ...
    public void ShowVictimDetails() {
        ...
        final androidx.appcompat.app.AlertDialog.Builder dialog = new androidx.appcompat.app.AlertDialog.Builder(MedicalTeamDispatcher.this);
...
//                }
        ...
        if(!gps_enabled && !network_enabled){
            ...
            builder.setMessage("Your Location seems to be disabled, do you want to enable it?")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        public void onClick(final DialogInterface dialog, final int id) {
                            Intent i = new Intent(MedicalTeamDispatcher.this, showmessage.class);
                            startActivity(i);
                            dialog.cancel();
    ...
    public void ShowPickedDialog() {
        ...
        dialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                final DatabaseReference assignVictimRef = FirebaseDatabase.getInstance().getReference().child("MedicalRequest");

                GeoFire geoFire = new GeoFire(assignVictimRef);
                geoFire.removeLocation(UserID, new GeoFire.CompletionListener() {
                    @Override
                    public void onComplete(String key, DatabaseError error) {
                        Toast.makeText(MedicalTeamDispatcher.this, "User Picked Congratulation!!!!", Toast.LENGTH_SHORT).show();
    ...
    public void showDropDialog(){
        ...
        dialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
                DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Dispatcher").child("MedicalRequest").child(userId).child("userRideId");
                driverRef.removeValue();
