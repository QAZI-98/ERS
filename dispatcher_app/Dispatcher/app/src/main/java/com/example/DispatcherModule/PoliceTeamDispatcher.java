...
import static com.example.DispatcherModule.FireFighterDispatcher.round;

public class PoliceTeamDispatcher extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_police_team_dispatcher);
...
//        btnshow = (Button) findViewById(R.id.showDetails);
    ...
    public void noShow(){
        Toast.makeText(PoliceTeamDispatcher.this,"Currently no Police Reported!",Toast.LENGTH_SHORT).show();
    }
    public void showLogout(){

        final androidx.appcompat.app.AlertDialog.Builder dialog = new androidx.appcompat.app.AlertDialog.Builder(PoliceTeamDispatcher.this,R.style.AlertDialog);
//                final androidx.appcompat.app.AlertDialog alertDialog = dialog.create();
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                actualDistance = 0;
                FirebaseAuth.getInstance().signOut();
                Intent intent = new Intent(PoliceTeamDispatcher.this, MainActivity.class);
                startActivity(intent);
                alertDialog.dismiss();
                finish();
    ...
    private void getAssignedCustomer(){
        ...
        final DatabaseReference assignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Dispatcher").child("PoliceTeam").child(driverId).child("userRideId");
    ...
    private void alertDispatcher() {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,CHANNEL_ID)
                ...
                .setContentTitle("Police Alert!")
                .setContentText("Police has been Requested! ")
    ...
    private void getAssignedCustomerPickupLocation(){
        assignedCustomerPickupLocationRef = FirebaseDatabase.getInstance().getReference().child("PoliceRequest").child(customerId).child("l");
        ...
        assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                  ...
                  // double dddd =  distanceBetween ();
                //   double distance =mLastLocation.distanceTo(loc1) / 1000;
                    double distance = SphericalUtil.computeDistanceBetween(pickupLatLang, dipatcherLocationLatLng);
                    getRouteToMarker(pickupLatLang);



                    Toast.makeText(PoliceTeamDispatcher.this, "Distance " + distance, Toast.LENGTH_SHORT).show();
...
//            mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
            ...
            DatabaseReference refAvailable = FirebaseDatabase.getInstance().getReference("PoliceTeamAvailable");
            DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("PoliceTeamWorking");
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(PoliceTeamDispatcher.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
        ...
        switch (requestCode) {
            case LOCATION_REQUEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(PoliceTeamDispatcher.this, "Please provide the permission", Toast.LENGTH_SHORT).show();
                }
                break;
            }
    ...
    private void disconnectDriver(){
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("PoliceTeamAvailable");
        actualDistance = 0;
        GeoFire geoFire = new GeoFire(ref);
        geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
            @Override
            public void onComplete(String key, DatabaseError error) {
                Toast.makeText(PoliceTeamDispatcher.this, "You are now Offline", Toast.LENGTH_SHORT).show();
...
//                dialog.setView(trip_layout);
    ...
    private void endRide(){
        ...
        DatabaseReference driverRef  = FirebaseDatabase.getInstance().getReference().child("Users").child("Dispatcher").child("PoliceTeam").child(userId).child("userRideId");
        ...
        geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
            @Override
            public void onComplete(String key, DatabaseError error) {
                Toast.makeText(PoliceTeamDispatcher.this,"Service Done",Toast.LENGTH_LONG).show();
    ...
    public void ShowVictimDetails() {
        ...
        final androidx.appcompat.app.AlertDialog.Builder dialog = new androidx.appcompat.app.AlertDialog.Builder(PoliceTeamDispatcher.this);
        dialog.setIcon(R.drawable.user);

        LayoutInflater inflater = LayoutInflater.from(PoliceTeamDispatcher.this);
        ...
        dialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                geoFire.removeLocation(UserID, new GeoFire.CompletionListener() {
                    @Override
                    public void onComplete(String key, DatabaseError error) {
                        Toast.makeText(PoliceTeamDispatcher.this, "User Picked Congratulation!!!!", Toast.LENGTH_SHORT).show();
